...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Menum.controller.Home": [],
  "Menum.controller.MainNavigation": [],
  "Menum.controller.menu.Menu": [],
  "Menum.controller.menu.RestaurantSelectionList": [],
  "Menum.controller.restaurant.Restaurant": [],
  "Menum.controller.restaurant.Search": [],
  "Menum.controller.restaurant.SearchResultList": [],
  "Menum.model.menu.MenuItem": [],
  "Menum.model.restaurant.Restaurant": [],
  "Menum.model.restaurant.ShortRestaurant": [],
  "Menum.store.menu.Menu": [],
  "Menum.store.restaurant.Restaurant": [],
  "Menum.store.restaurant.Restaurants": [],
  "Menum.util.Config": [],
  "Menum.util.GeolocationManager": [],
  "Menum.util.dataview.component.NestedDataItem": [],
  "Menum.util.field.TravelModeSelect": [],
  "Menum.view.Home": [],
  "Menum.view.MainContainer": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Menum.util.GeolocationManager": [],
  "Menum.util.dataview.component.NestedDataItem": [
    "widget.nesteddataitem"
  ],
  "Menum.util.field.TravelModeSelect": [
    "widget.travelmodeselectfield"
  ],
  "Menum.view.Home": [
    "widget.homepanel"
  ],
  ...
  "Menum.view.menu.MenuItem": [
    "widget.menuitempanel"
  ],
  "Menum.view.menu.RestaurantSelectionList": [
    "widget.restaurantselectionlist"
  ],
  "Menum.view.restaurant.Restaurant": [
    "widget.restaurantpanel"
  ],
  "Menum.view.restaurant.RestaurantDirections": [
    "widget.restaurantdirections"
  ],
  "Menum.view.restaurant.Search": [
    "widget.restaurantsearchform"
  ],
  "Menum.view.restaurant.SearchResultList": [
    "widget.restaurantsearchresultlist"
  ],
  "Ux.locale.Manager": [],
  "Ux.locale.override.extjs.Button": [],
  "Ux.locale.override.extjs.Component": [],
