var app = {
    ...
    addBanner: function () {
        ...
        admobAd.initBanner("your admob id here", admobAd.AD_SIZE.BANNER.width, admobAd.AD_SIZE.BANNER.height, successCreateBannerView, errorCreateBannerView);
    },
    ...
    addInterstitial: function () {
        ...
        admobAd.initInterstitial("your admob id here", successCreateInterstitial);
    },
